...
<body class="sb-nav-fixed">
            ...
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a class="nav-link" href="kproduk.php">
                            <div class="sb-nav-link-icon"><i class="fas fa-table"></i></div>
                            List Produk
                        </a>
                        <a class="nav-link" href="kpesanan.php">
                            <div class="sb-nav-link-icon"><i class="fas fa-table"></i></div>
                            Pesanan
                        </a>
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h3 class="mt-4 keren">Dashboard</h3>
                    <div class="mb-4"><a href="">Monday ∙ 15 Mei 2023 ∙ 22.00 PM</a></div>
                    <div class="row">
    ...
    <script src="../../assets/script/chart-bar-demo.js"></script>
